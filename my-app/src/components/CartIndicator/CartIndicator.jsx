...
class CartIndicator extends Component {
    ...
    componentDidMount() {
        if (this.context && this.context.refreshCart) {
            this.context.refreshCart();
        } else if (this.context && this.context.loadCart) {
            this.context.loadCart();
        }
    }
    ...
    render() {
        ...
        return (
            <button className="icon-btn cart-icon" onClick={this.handleCartClick}>
